...
function Footer() {
    return (
        <footer className="px-[28px] md:px[50px] bg-[#030327] text-white">

            <div className="flex flex-col items-center gap-8">
                <h2 className="text-[52px] font-extrabold">Elon Coin</h2>
                <div className="flex justify-between  capitalize flex-1 gap-4 w-fit">
                    <a href="#">Home</a>
                    <a href="#">About</a>
                    <a href="#">How to buy</a>
                    <a href="#">Contact us</a>
                ...
                <div className=" mt-10 flex justify-between self-start w-full font-semibold ">
