    ...
    <div className=" w-full flex flex-col items-start">
      <input
        ...
        className={`w-full px-4 py-3 rounded-md border bg-white text-gray-800
                     ...
                     max-w-[400px]  ${status === 'valid' ? 'border-green-500 focus:ring-green-300' :
      ...
      <div className="mt-2 text-sm ">
        ...
        {status == 'valid' && <div className=" rounded-lg pb-4  text-center">
          You will get <span className="text-purple-800 text-xl">{amount * 4000}</span> Elon Coin
        </div>}
      </div>
    </div>
  );
